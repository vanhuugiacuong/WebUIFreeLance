  ...
  return (
    <div className={cn("relative @container w-full max-w-[1000px] group cursor-pointer transition-transform duration-500 hover:scale-[1.03]", className)}>
      ...
      >
        ...
        <span
          aria-hidden
          className="absolute top-1/2 left-1/2 size-[3.5cqw] -translate-x-1/2 -translate-y-1/2 rotate-45 border-[0.15cqw] border-kem bg-cam transition-transform duration-700 group-hover:rotate-[225deg]"
        />
